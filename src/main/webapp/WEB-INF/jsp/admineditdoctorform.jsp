...
<h3 class="text-center"><b>Edit Doctor Form</b></h3>
<br>
<form:form class="form-horizontal" method="post" action="/SpringMVCProject/editdoctorsave" modelAttribute="doctor" onsubmit="return validate()">
    <form:hidden  path="iddoctor" />
  <div class="col-sm-6">
    <div class="form-group">
      <label class="control-label col-sm-4">Name</label>
      <div class="col-sm-8">
        <form:input class="form-control" path="name" id="name" readonly="true"/>
