...
<form action="/SpringMVCProject/doctorsearchpatient" method="post">
<table class="search">
	<tr>
...
<nav>
  <ul class="pagination">
    <li class="page-item"><a class="page-link" href="/SpringMVCProject/doctorviewpatient/1">1</a></li>
    <li class="page-item"><a class="page-link" href="/SpringMVCProject/doctorviewpatient/2">2</a></li>
  </ul>
</nav>
</div>
</body>
