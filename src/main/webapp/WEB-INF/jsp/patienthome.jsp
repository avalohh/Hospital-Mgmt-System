    ...
    <div class="col-md-4">
      <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <a href="bookappointment"><span class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="bottom" title="Book Appointment">Book</span></a> &nbsp;&nbsp;
            <a href="patientviewappointment"><span class="glyphicon glyphicon-minus-sign" data-toggle="tooltip" data-placement="bottom" title="Cancel Appointment">Cancel</span></a>&nbsp;&nbsp;
            <a href="patientviewappointment"><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="bottom" title="View Appointment">View</span></a>
          </div>
      </div>
    </div>
    <div class="col-md-4">
      <div class="thumbnail">
          <img src="https://www.medicalcheckup.com.my/wp-content/uploads/2020/09/filling-medical-record.jpg" alt="manage package" style="width:90%"/>
          <div class="caption">
            <p>Manage Package</p>
            <a href="buypackage"><span class="glyphicon glyphicon-plus-sign" data-toggle="tooltip" data-placement="bottom" title="Buy Package">Buy</span></a> &nbsp;&nbsp;
            <a href="patientvieworder"><span class="glyphicon glyphicon-info-sign" data-toggle="tooltip" data-placement="bottom" title="View Package">View</span></a>
          </div>
        </a>
      </div>
    </div>
